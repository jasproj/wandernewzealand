...
**Based on:** WanderNZ.com launch campaign  
**Author:** Claude + Jason  
...
This playbook documents the complete advertising and analytics setup for WanderNZ.com. Use it to replicate the process for new market sites (WanderPuertoRico, FloridaSandbarTours, KeyWestSandbarTours, etc.).
...
## Appendix: WanderNZ Results (First 3 Days)
