/* ============================================
   ...
   Fires only when the clicked anchor's href contains fareharbor.com.
   CTA/button classes are never sufficient on their own — internal nav,
   scroll-to-section, and #anchor links must never count as bookings.
...
(function () {
    /* HOSTNAME GUARD — booking_click is emitted from the live domain only.
       ...
       runs, not users. This property recorded 0 localhost booking_click to date; the guard is preventive, and 29% of its 90-day sessions were localhost.
    ...
    var BOOKING_CLICK_ALLOWED_HOSTS = ['wandernewzealand.com', 'www.wandernewzealand.com'];
